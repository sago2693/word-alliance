...
#SBATCH -t 04:30:00                  # estimated time # TODO: adapt to your needs
...
python -u multitask_classifier.py --option finetune --lr 1e-5 --batch_size 64 --local_files_only --use_gpu --epochs 5
